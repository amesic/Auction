...
public class CharacteristicService implements ICharacteristicService{
    ...
    @Override
    public NumberOfProductsInfo characteristic(String name) {
        return productRepository.numberOfProductsByCharacteristic(characteristicRepository.findCharacteristicByName(name));
    }
}
